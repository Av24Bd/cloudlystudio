        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center justify-between pb-4 border-b-2 border-gray-200">
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-emerald-50 border-2 border-emerald-200">
                        <span className="relative flex h-2 w-2">
                            <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-500 opacity-75"></span>
                            <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-600"></span>
                        </span>
                        <span className="text-xs font-bold uppercase tracking-wide text-emerald-700">Live Tracking</span>
                    </div>
                ...
                <button
                    ...
                    className="group flex items-center gap-2 px-4 py-2 bg-white hover:bg-gray-50 text-gray-700 font-medium rounded-lg transition-all border-2 border-gray-300 hover:border-gray-400 shadow-sm"
                >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                ...
                {/* Live Feed Panel */}
                <div className="lg:col-span-4 bg-white border-2 border-gray-200 rounded-xl overflow-hidden shadow-sm">
                    <div className="px-6 py-4 border-b-2 border-gray-200 flex items-center justify-between bg-gray-50">
                        <div className="flex items-center gap-4">
                            ...
                            {activeFilter && (
                                <div className="flex items-center gap-2 px-3 py-1 rounded-lg bg-blue-50 text-blue-700 border border-blue-200 text-sm font-medium">
                                    <Filter className="w-3 h-3" />
                                    {activeFilter.type}: {activeFilter.value}
                                    <button onClick={() => setActiveFilter(null)} className="ml-1 hover:text-blue-900"><X className="w-3 h-3" /></button>
                                </div>
                            )}
                        </div>
                        <span className="text-xs font-bold bg-gray-200 text-gray-700 px-3 py-1.5 rounded-lg">
                    ...
                    <div className="overflow-x-auto max-h-[500px] overflow-y-auto">
                        <table className="w-full text-left text-sm">
                            <thead className="sticky top-0 bg-gray-100 border-b-2 border-gray-200">
                                <tr>
                                    <th className="px-6 py-3 text-xs font-bold text-gray-700 uppercase tracking-wide">Time</th>
                                    <th className="px-6 py-3 text-xs font-bold text-gray-700 uppercase tracking-wide">Location</th>
                                    <th className="px-6 py-3 text-xs font-bold text-gray-700 uppercase tracking-wide">Identity / Network</th>
                                    <th className="px-6 py-3 text-xs font-bold text-gray-700 uppercase tracking-wide">Source</th>
                                    <th className="px-6 py-3 text-xs font-bold text-gray-700 uppercase tracking-wide text-right">Page</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-gray-100">
                                {loading && visitors.length === 0 ? (
                                    ...
                                    <tr>
                                        <td colSpan={5} className="p-24 text-center text-gray-500 font-medium">
                                    ...
                                    filteredVisitors.map((visitor) => {
                                        ...
                                        return (
                                            <tr key={visitor.id} className="group hover:bg-blue-50 transition-colors">
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="flex items-center gap-3">
                                                        <div className="p-2 rounded-lg bg-gray-100 text-gray-700 group-hover:bg-blue-100 transition-all">
                                                            <Clock className="w-3.5 h-3.5" />
                                                        </div>
                                                        <div>
                                                            <div className="text-gray-900 font-semibold text-xs">{formatTime(visitor.timestamp)}</div>
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="flex items-center gap-2">
                                                        {identities[visitor.ip_address] ? (
                                                            <div className="flex items-center gap-2">
                                                                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-emerald-50 text-emerald-700 border-2 border-emerald-200">
                                                                ...
                                                                <button
                                                                    ...
                                                                    className="p-1.5 text-gray-400 hover:text-gray-700 hover:bg-gray-100 rounded transition-colors opacity-0 group-hover:opacity-100"
                                                                    title="Edit Label"
                                                                >
                                                            ...
                                                            <div className="flex items-center gap-2 group/id">
                                                                {visitor.org !== 'unknown' && !visitor.org.includes('AS') ? (
                                                                    <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-blue-50 text-blue-700 border-2 border-blue-200">
                                                                        <Building2 className="w-3.5 h-3.5" />
                                                                        <span className="font-semibold text-xs truncate max-w-[250px]">{visitor.org}</span>
                                                                    </div>
                                                                ) : (
                                                                    <div className="flex items-center gap-2 text-gray-600 bg-gray-100 px-3 py-1.5 rounded-lg border border-gray-200">
                                                                        <Activity className="w-3.5 h-3.5" />
                                                                        <span className="text-xs font-medium truncate max-w-[250px]" title={visitor.org}>
                                                ...
                                                <td className="px-6 py-4">
                                                    <div className="flex flex-col gap-1">
                                                        <div className="flex items-center gap-2 text-sm text-gray-700" title={`Referrer: ${visitor.referrer || '(none)'}`}>
                                                            <Link className="w-3 h-3 text-gray-400" />
                                                            <span className={`truncate max-w-[150px] font-medium ${source.type === 'direct' ? 'text-gray-500 italic' : 'text-gray-900'}`}>
                                                                {source.name}
                                                            </span>
                                                        </div>
                                                        {source.keyphrase && (
                                                ...
                                                <td className="px-6 py-4 text-right">
                                                    <a href={visitor.path} target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 text-gray-700 hover:text-gray-900 transition-colors text-xs bg-gray-100 hover:bg-gray-200 border border-gray-200 hover:border-gray-300 px-3 py-1.5 rounded-lg font-medium">
                ...
                <div className="bg-white border-2 border-gray-200 rounded-xl p-6 shadow-sm">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <h4 className="text-gray-900 font-bold">Top Regions</h4>
                    ...
                    <div className="space-y-2">
                        {stats.topCities.length > 0 ? stats.topCities.map(([location, count]) => (
                            <div
                                ...
                                className="flex items-center justify-between p-3 rounded-lg hover:bg-blue-50 cursor-pointer group transition-colors border border-transparent hover:border-blue-200"
                            >
                                <span className="text-sm text-gray-700 group-hover:text-gray-900 truncate font-medium">{location}</span>
                                <span className="text-xs font-bold text-gray-900 bg-gray-100 px-2 py-1 rounded">
                                    {count}
                                </span>
                            </div>
                        )) : (
                            <p className="text-sm text-gray-400 p-4 text-center">Not enough data</p>
                        )}
                    </div>
                </div>
                ...
                <div className="bg-white border-2 border-gray-200 rounded-xl p-6 shadow-sm">
                    <div className="flex items-center gap-3 mb-4">
                        <div className="w-10 h-10 rounded-lg bg-emerald-50 flex items-center justify-center border-2 border-emerald-200">
                            <Building2 className="w-5 h-5 text-emerald-600" />
                        </div>
                        <div>
                            <h4 className="text-gray-900 font-bold">Top Entities</h4>
                            <p className="text-xs text-gray-500">Most active networks</p>
                        </div>
                    </div>
                    <div className="space-y-2">
                        {stats.topOrgs.length > 0 ? stats.topOrgs.map(([org, count]) => (
                            <div
                                ...
                                className="flex items-center justify-between p-3 rounded-lg hover:bg-emerald-50 cursor-pointer group transition-colors border border-transparent hover:border-emerald-200"
                            >
                                <span className="text-sm text-gray-700 group-hover:text-gray-900 truncate font-medium">{org}</span>
                                <span className="text-xs font-bold text-gray-900 bg-gray-100 px-2 py-1 rounded">
                                    {count}
                                </span>
                            </div>
                ...
                <div className="bg-white border-2 border-gray-200 rounded-xl p-6 shadow-sm">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <div>
                            <h4 className="text-gray-900 font-bold">Traffic Sources</h4>
                    ...
                    <div className="space-y-2">
                        {stats.topSources.length > 0 ? stats.topSources.map(([source, count]) => (
                            <div
                                ...
                                className="flex items-center justify-between p-3 rounded-lg hover:bg-purple-50 cursor-pointer group transition-colors border border-transparent hover:border-purple-200"
                            >
                                <span className="text-sm text-gray-700 group-hover:text-gray-900 truncate font-medium">{source}</span>
                                <span className="text-xs font-bold text-gray-900 bg-gray-100 px-2 py-1 rounded">
                                    {count}
                                </span>
                            </div>
                ...
                <div className="bg-white border-2 border-gray-200 rounded-xl p-6 shadow-sm">
                    <div className="flex items-center gap-3 mb-4">
                        <div className="w-10 h-10 rounded-lg bg-amber-50 flex items-center justify-center border-2 border-amber-200">
                            <Search className="w-5 h-5 text-amber-600" />
                        </div>
                        <div>
                            <h4 className="text-gray-900 font-bold">Top Keywords</h4>
                            <p className="text-xs text-gray-500">Search terms (when available)</p>
                        </div>
                    </div>
                    <div className="space-y-2">
                        {stats.topPhrases.length > 0 ? stats.topPhrases.map(([phrase, count]) => (
                            <div
                                ...
                                className="flex items-center justify-between p-3 rounded-lg hover:bg-amber-50 cursor-pointer group transition-colors border border-transparent hover:border-amber-200"
                            >
                                <span className="text-sm text-gray-700 group-hover:text-gray-900 truncate font-medium capitalize">{phrase}</span>
                                <span className="text-xs font-bold text-gray-900 bg-gray-100 px-2 py-1 rounded">
                                    {count}
                                </span>
                            </div>
                            ...
                            <p className="text-sm text-gray-400 p-4 text-center italic">
                                No terms detected
                                <br />
                                <span className="text-xs text-gray-400">(Google encrypts searches)</span>
                            </p>
                        )}
                    </div>
                </div>
